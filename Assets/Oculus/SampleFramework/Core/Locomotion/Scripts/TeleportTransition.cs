...
/// <summary>
/// Teleport transitions manage the actual relocation of the playerTransform from the current position and orientation
...
public abstract class TeleportTransition : TeleportSupport
{
    ...
    /// <summary>
    /// When the teleport state is entered, simply move the playerTransform to the new location
