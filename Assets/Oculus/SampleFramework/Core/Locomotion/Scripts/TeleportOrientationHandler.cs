...
/// <summary>
/// The orientation handler is what determines the final rotation of the playerTransform after the teleport.
/// </summary>
public abstract class TeleportOrientationHandler : TeleportSupport
{
    ...
    {
        /// <summary>
        /// When the playerTransform teleports, they will match the orientation of the destination indicator without adjusting their HMD's
        /// orientation.
        /// </summary>
        HeadRelative,

        /// <summary>
        /// When the playerTransform teleports, the playerTransform will be oriented so that when they turn the HMD to match the destination indicator,
        /// they will be facing forward with respect to the Oculus sensor setup. They will not immediately face the direction of the
        /// indicator, and will need to rotated the HMD view to match the indicated direction. Once rotated, the playerTransform will be facing
