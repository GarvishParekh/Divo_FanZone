...
/// <summary>
/// This transition will move the playerTransform to the destination over the span of a fixed amount of time.
/// It will not adjust the orientation of the playerTransform because this is very uncomfortable.
...
public class TeleportTransitionWarp : TeleportTransition
{
    ...
    /// <summary>
    /// When the teleport state is entered, quickly move the playerTransform to the new location
